...
if __name__ == "__main__":
    import argparse
    parser=argparse.ArgumentParser(description='Generic shell job manager.  Will take a list of shell commands and a number of threads and will keep that many jobs running at all times.')
