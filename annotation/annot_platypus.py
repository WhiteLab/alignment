...
def annot_platypus(config_file, sample, ref_mnt):
    ...
    (java, snpeff, snpsift, gatk, dbsnp, intervals) = parse_config(config_file)
    pass_filter(sample)
    dbsnp = ref_mnt + '/' + dbsnp
    ...
    #            '.germline_pass.xls -F CHROM POS REF ALT -GF '
    return 0
...
if __name__ == "__main__":
    ...
    annot_platypus(config_file, sample_pairs, ref_mnt, cflag)
