...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description='Picard tools remove duplicate module.  Removes duplicates from BAM file, run after sorting BAM.')
    ...
    parser.add_argument('-r', '--ram', action='store', dest='ram',
                        help='RAM to use in GB.  24 suggested in standard vm')
