...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description='Picard tool to reorder BAM file by karyotypic order, necessary for running muTect.')
    ...
    parser.add_argument('-o', '--overwrite', action='store', dest='flag',
                        help='Enter \'y\' or \'n.\' Flag to overwrite original after reordering or not.')
